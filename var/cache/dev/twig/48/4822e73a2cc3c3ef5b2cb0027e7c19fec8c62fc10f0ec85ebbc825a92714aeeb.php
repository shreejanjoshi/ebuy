...
class __TwigTemplate_688124dc79d943fe2ed4ea308b518b0f9aac1677711b17cd9b28bd2d4b3cad15 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["productCreateForm"]) || array_key_exists("productCreateForm", $context) ? $context["productCreateForm"] : (function () { throw new RuntimeError('Variable "productCreateForm" does not exist.', 8, $this->source); })()), 'form');
        echo "
</div>
...
{% endblock %}", "product/create.html.twig", "E:\\Users\\Lakne\\Desktop\\becode\\Week 1\\Ebuy\\ebuy\\templates\\product\\create.html.twig");
    }
}
