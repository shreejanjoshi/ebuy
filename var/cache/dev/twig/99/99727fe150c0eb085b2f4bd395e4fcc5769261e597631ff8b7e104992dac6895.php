...
class __TwigTemplate_f26a29123c1994cd058f47c76dce39c976470f980bfa49143ed45015cbb3c8fe extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 10
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["regform"]) || array_key_exists("regform", $context) ? $context["regform"] : (function () { throw new RuntimeError('Variable "regform" does not exist.', 10, $this->source); })()), 'form');
        echo "
</div>
";
...
{% endblock %}
", "register/index.html.twig", "C:\\xampp\\htdocs\\ebuy\\templates\\register\\index.html.twig");
    }
}
