...
class __TwigTemplate_d13399cb48bd84c34231e98b1c279d8d39959b67ccbeaf3b29229277292a6dc9 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 5, $this->source); })())) {
            // line 6
            echo "        <div class=\"alert alert-danger\">Please enter a correct email and password.</div>
    ";
        }
        // line 8
        echo "
...
";
    ...
    {
        return array (  122 => 41,  116 => 29,  110 => 26,  102 => 21,  93 => 14,  85 => 11,  82 => 10,  80 => 9,  77 => 8,  73 => 6,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
<form method=\"post\">
    {% if error %}
        <div class=\"alert alert-danger\">Please enter a correct email and password.</div>
    {% endif %}
...
{% endblock %}", "security/login.html.twig", "E:\\Users\\Lakne\\Desktop\\becode\\Week 1\\Ebuy\\ebuy\\templates\\security\\login.html.twig");
    }
}
